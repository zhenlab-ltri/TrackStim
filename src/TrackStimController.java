...
class TrackStimController {
    ...
    ArrayList<ScheduledFuture> stimulatorTasks;
    ...
    void startImageAcquisition(int numFrames, int framesPerSecond, String rootDirectory){
    ...
    // schedule a number of snapshot at fixed time interval (computed via fps)
